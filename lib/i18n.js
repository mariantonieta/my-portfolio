  ...
  en: {
    translation: {
      ...
      portfolioPage: {
        ...
        note: "The Fisioterapia Paulina Rodriguez website opens the selection as the featured freelance project, and OSTO appears right after it as the second visible piece.",
      },
      projects: {
        featured: {
